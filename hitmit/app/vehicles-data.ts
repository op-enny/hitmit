...
export const COMFORT_FEATURES_BY_TYPE: Record<string, string[]> = {
  PKW: [
    ...
    "---Sitze",
    "Sitzheizung", "Sitzbelüftung vorne", "Sitzbelüftung hinten", "Elektrische Sitze", "Elektrische Sitze vorne mit Memory (Fahrer)", "Elektrische Sitze mit Memory (Fahrer & Beifahrer)", "Massagesitze vorne", "Massagesitze vorne & hinten", "Lordosenstütze", "Armlehne", "Mittelarmlehne Fond", "Multifunktions-Armlehne", "Rücksitze umklappbar", "Einzelsitzanlage im Fond",
    "---Heizung",
    "Lenkradheizung", "Standheizung", "Beheizbare Frontscheibe",
    "---Dach",
    "Panoramadach", "Schiebedach", "Glasdach (fest)",
    "---Elektrische Helfer",
    "Elektrische Fensterheber", "Elektrische Spiegelverstellung", "Elektrisch anklappbare Spiegel", "Elektrische Heckklappe", "Elektrisches Heckrollo", "Soft-Close-Automatik", "Elektrische Türöffnung/Schließung",
    "---Zugang & Sicherung",
    "Zentralverriegelung", "Keyless Entry", "Keyless-Go", "Handschuhfach abschließbar",
    "---Fahrassistenz",
    "Tempomat", "Limiter", "Abstandsregeltempomat", "Hinterachslenkung",
...
export const MULTIMEDIA_FEATURES_BY_TYPE: Record<string, string[]> = {
  PKW: [
    ...
    "---Konnektivität",
    "Apple CarPlay", "Android Auto", "Bluetooth", "WLAN-Hotspot", "Online-Services", "Gestiksteuerung",
    "---Audio",
    ...
    "---Unterhaltung",
    "Fond-Entertainment", "Fond-Entertainment (Vorrüstung)",
  ],
  Motorrad: [
